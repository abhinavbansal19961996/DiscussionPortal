<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="user_profile.aspx.cs" Inherits="_Default" %>
...
<h3>SID : <asp:Label ID="lb2" runat="server" /> </h3>
